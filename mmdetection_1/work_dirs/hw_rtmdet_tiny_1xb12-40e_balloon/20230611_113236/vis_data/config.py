...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data_balloon/',
        ann_file='annotations/annotation_coco_train.json',
        ...
        backend_args=None,
        metainfo=dict(classes=('bolloon', ), palette=[(220, 20, 60)])),
    pin_memory=False)
val_dataloader = dict(
    batch_size=1,
    num_workers=2,
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data_balloon/',
        ann_file='annotations/annotation_coco_val.json',
        data_prefix=dict(img='images/'),
        test_mode=True,
        pipeline=[
            dict(type='LoadImageFromFile', backend_args=None),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='data_balloon/val/annotation_coco.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
...
num_epochs_stage2 = 5
launcher = 'none'
work_dir = './work_dirs/hw_rtmdet_tiny_1xb12-40e_balloon'
